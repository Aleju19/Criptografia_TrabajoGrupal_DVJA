...
* **Integrante 1 (Pentester / QA):** David Ortega - Encargado del diagnóstico ofensivo, levantamiento del entorno inicial (Docker Compose), explotación controlada de vulnerabilidades OWASP Top Ten y documentación de evidencias técnicas (Fase 1).
* **Integrante 2 (Secure Developer / Dev):** Edwin de la Cruz - Encargado de la modificación del código fuente en Java, implementación de hashing robusto para contraseñas (BCrypt) y sanitización de consultas dinámicas mediante parametrización SQL (Fase 2).
